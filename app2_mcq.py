...
st.title("RAG-based Question-Answer System with MCQs")
...
if uploaded_file is not None:
    ...
    if text:
        ...
        try:
            ...
            with st.spinner("Generating quetions..."):
                
                # Générer des MCQs
                prompt = f"""Based on the following text, generate 5 multiple choice questions with 4 options each and their correct answers.
